                            ...
                            {props.products.map((beer) => {
                                return (
                                    ...
                                    <tr key={beer.id} className="index" >
                                        ...
                                        <td>{beer.stock}</td>
                                        <td>{beer.volume}</td>
                                        <td><button className="edit" onClick={() => { props.seteadora(props.estados[1], props.estados[0]); handleOnUpdate(beer) }}>edit</button></td>
                                        <td><button className="x" onClick={() => { props.deleteProduct(beer.id); }}>x</button></td>
                                    </tr>
