...
INSERT INTO product (name, appearance, description, price, stock, volume, thumbnail)

VALUES ('Amber Lager', 'Color ambar, rojjos brillantes, espuma blanca.', 'Sabor maltoso, caramelo leve tostado que deja un sutil dulzor en la boca.', 170, 50, '730 cc', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHlzdC432zyFNkwS2cQx_bCWsNQf3y5f0be70qptJvvb98WdHGUGwJrsEtPafjg_QA5Rgui6PxQYA&usqp=CAc'),
('Amber Lager', 'Color ambar, rojjos brillantes, espuma blanca.', 'Sabor maltoso, caramelo leve tostado que deja un sutil dulzor en la boca.', 130, 0, '473 cc', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYvKfnk3QMbPM3SzUoV6JTs3PIbHRbtIIUfSm-xcdDgQ0b6aHeDdPBLd2KeIM-lgvDKAstKLY&usqp=CAc'),
('Amber Lager', 'Color ambar, rojjos brillantes, espuma blanca.', 'Sabor maltoso, caramelo leve tostado que deja un sutil dulzor en la boca.', 100, 30, '355 cc', 'https://emporiodacerveja.vtexassets.com/arquivos/ids/176098/Cerveja-Patagonia-Amber-Lager-Long-Neck-355ml.jpg?v=637212809310330000'),
('Bohemian Pilsener', 'Color dorado brillante, espuma densa', 'Sabor maltoso, con buen cuerpo y un ﬁnal amargo persistente.', 185, 50, '730 cc', 'https://emporiodacerveja.vteximg.com.br/arquivos/ids/174178-1000-1000/Cerveja-Patagonia-Bohemian-Pilsener-740ml.jpg?v=637008826268730000'),
('Bohemian Pilsener', 'Color dorado brillante, espuma densa', 'Sabor maltoso, con buen cuerpo y un ﬁnal amargo persistente.', 140, 50, '473 cc', 'https://www.clubcervecero.com.py/tienda/web/assets/images/productos/Patagonia%20Bohemian%20269_kqbmu2yb.jpg'),
('Bohemian Pilsener', 'Color dorado brillante, espuma densa', 'Sabor maltoso, con buen cuerpo y un ﬁnal amargo persistente.', 110, 0, '355 cc', 'https://emporiodacerveja.vteximg.com.br/arquivos/ids/176099-1000-1000/Cerveja-Patagonia-Bohemian-Pilsener-Long-Neck--355ML.jpg?v=637212810036370000'),
('Hoppy Lager', 'Color dorado profundo, espuma densa y duradera, leve opalesencia por ser una cerveza sin filtrar(para conservar aromas)', 'Con una maltosidad que equilibra el amargor, haciéndole muy fácil de tomar. De final seco y balanceado, que invitan a probar otro trago inmediatamente.Amargo bajo y cuerpo moderado.', 170, 100, '730 cc','https://www.elreferente.com.ar/assets/images/productos/fotoproducto421_1585835279.jpg'),
('Hoppy Lager', 'Color dorado profundo, espuma densa y duradera, leve opalesencia por ser una cerveza sin filtrar(para conservar aromas)', 'Con una maltosidad que equilibra el amargor, haciéndole muy fácil de tomar. De final seco y balanceado, que invitan a probar otro trago inmediatamente.Amargo bajo y cuerpo moderado.', 130, 10, '473 cc','https://www.clubcervecero.com.py/tienda/web/assets/images/productos/Patagonia%20Lata%20hoppy%20269_dfv2smgm.jpg'),
...
('Kilometro 24.7', 'Dorado profundo con un leve tinte rosado por el sauco, espuma blanca intensa', 'Suave lupulado que le da un amargor elegante, balanceado con la acidez leve del sauco. De cuerpo liviano y muy refrescante.', 155, 50, '473 cc', 'http://www.clubcervecero.com.py/tienda/web/assets/images/productos/PATAGONIA-24.7-LATA-473-ML_xtaed7og.jpg'),
('Kilometro 24.7', 'Dorado profundo con un leve tinte rosado por el sauco, espuma blanca intensa', 'Suave lupulado que le da un amargor elegante, balanceado con la acidez leve del sauco. De cuerpo liviano y muy refrescante.', 130, 30, '355 cc', 'https://emporiodacerveja.vtexassets.com/arquivos/ids/177121/CervejaPatagonia247_1000x1000px.jpg?v=637311895367600000'),
('Kúne', 'Color bronce claro con espuma clara cremosa, de claridad brillante', 'Amargo suave con notas leves a caramelo de la malta.', 190, 100, '730 cc', 'https://www.bessaudiovideo.com/produtos_img/1/4/5/4/5/8/IMG_145458_1.JPG'),
('Kúne', 'Color bronce claro con espuma clara cremosa, de claridad brillante', 'Amargo suave con notas leves a caramelo de la malta.', 155, 20, '473 cc', 'https://www.bessaudiovideo.com/produtos_img/1/4/5/4/5/8/IMG_145458_1.JPG'),
('Kúne', 'Color bronce claro con espuma clara cremosa, de claridad brillante', 'Amargo suave con notas leves a caramelo de la malta.', 130, 70, '355 cc', 'https://www.superseis.com.py/images/thumbs/0209226.jpeg'),
('Porter', 'Color marron oscuro espuma color canela persistente y cremosa', 'Tostado, con un amargo del lúpulo que acompaña para darle un ﬁnal seco.', 180, 70, '730 cc', 'https://d26lpennugtm8s.cloudfront.net/stores/861/458/products/335371-d5bb01fa338479e48115671048376584-640-0.jpg'),
('Porter', 'Color marron oscuro espuma color canela persistente y cremosa', 'Tostado, con un amargo del lúpulo que acompaña para darle un ﬁnal seco.', 140, 60, '473 cc'),
('Porter', 'Color marron oscuro espuma color canela persistente y cremosa', 'Tostado, con un amargo del lúpulo que acompaña para darle un ﬁnal seco.', 110, 50, '355 cc'),
('Weisse', 'Color pajizo opalesente de espuma densa y cremosa', 'Muy refrescante, cítrico y cuerpo liviano.', 170, 50, '730 cc', 'https://emporiodacerveja.vteximg.com.br/arquivos/ids/173977-1000-1000/patagonia-weisse-nacional-740ml.jpg?v=636996792682870000'),
('Weisse', 'Color pajizo opalesente de espuma densa y cremosa', 'Muy refrescante, cítrico y cuerpo liviano.', 130, 50, '473 cc', 'https://elmundodelasado.com/285-large_default/patagonia-weisse-lata-473ml.jpg'),
('Weisse', 'Color pajizo opalesente de espuma densa y cremosa', 'Muy refrescante, cítrico y cuerpo liviano.', 100, 0, '355 cc', 'https://emporiodacerveja.vtexassets.com/arquivos/ids/176100-800-auto?width=800&height=auto&aspect=true'),
('Fernandez IPA', 'Color cobrizo anaranjado levemente opalescente, de espuma consistente', 'Se percibe la frescura del lúpulo recién cosechado, con un amargo elegante y bien presente.', 200, 0, '730 cc'),
('Fernandez IPA', 'Color cobrizo anaranjado levemente opalescente, de espuma consistente', 'Se percibe la frescura del lúpulo recién cosechado, con un amargo elegante y bien presente.', 160, 5, '473 cc', 'https://cdn.shopify.com/s/files/1/1103/5152/products/Patagonia_IPA_Fernandez_1000_x_2048_grande.jpg?v=1556030993'),
('Fernandez IPA', 'Color cobrizo anaranjado levemente opalescente, de espuma consistente', 'Se percibe la frescura del lúpulo recién cosechado, con un amargo elegante y bien presente.', 130, 0, '355 cc'),
('OCTUBREFEST', 'Color ambar cobrizo', 'Un sabor que parece empezar levemente dulce maltoso para terminar con un ﬁnal seco limpio.', 200, 5, '730 cc', 'https://www.clubcervecero.com.py/tienda/web/imagen.php?src=assets/images/productos/PATAGONIA-OCTUBREFEST-BOTELLA-730ML_jlu0ece6.jpg&x=632&y=948&r=0&c=1&v=1&e=1'),
('OCTUBREFEST', 'Color ambar cobrizo', 'Un sabor que parece empezar levemente dulce maltoso para terminar con un ﬁnal seco limpio.', 160, 5, '473 cc', 'https://images-ti-vm1.tiendainglesa.com.uy/medium/P449301-1.jpg?20181207102259,Cerveza-PATAGONIA-Octubrefest-lata-473ml-en-Tienda-Inglesa'),
('OCTUBREFEST', 'Color ambar cobrizo', 'Un sabor que parece empezar levemente dulce maltoso para terminar con un ﬁnal seco limpio.', 140, 0, '355 cc'),
